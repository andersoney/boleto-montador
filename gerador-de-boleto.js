...
var GeradorDeBoleto = (function () {
	...
	GeradorDeBoleto.prototype.gerarPDF = function (args, boletos = null) {
		...
		boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
			...
			pdf.font('normal')
				.fontSize(args.tamanhoDaFonte)
				.text(boleto.beneficiario.dadosBancarios.nossoNumero, 8, '0', args.ajusteX + 181, args.ajusteY + segundaLinha, {
					lineBreak: false,
					width: 294,
					align: 'left'
				});
			...
			pdf.font('normal')
				.fontSize(args.tamanhoDaFonte)
				.text(boleto.beneficiario.dadosBancarios.nossoNumero, 8, '0', args.ajusteX + colunaLateral, args.ajusteY + quintaLinha, {
					lineBreak: false,
					width: tamanhoDasCelulasADireita,
					align: 'right'
				});
